...
public class InquiryAdapterClass extends RecyclerView.Adapter<InquiryAdapterClass.ViewHolder> {
    ...
    List<InquiryModelClass> employee;
    Context context;
    DatabaseHelperClass databaseHelperClass;

    public InquiryAdapterClass(List<InquiryModelClass> employee, Context context) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        final InquiryModelClass employeeModelClass = employee.get(position);
        ...
        holder.button_Edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseHelperClass.updateEmployee(new InquiryModelClass(employeeModelClass.getId(),stringName,stringEmail));
